...
/** Processes actions when removing a reservation from the System
 * @author Paul M. Duvall, Stephen M. Matyas III
 */
public class RemoveReservationAction extends BaseAction  {
     ...
     * @return
     */
    public ActionForward unreserve(ActionMapping mapping,
    ActionForm form,
    ...
    HttpServletResponse response) throws LibraryException  {
        ...
        ItemMgr.getInstance().unreserveItem(user.getId(),  itemId);
